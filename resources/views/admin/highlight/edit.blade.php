...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="/highlight/{{$highlight->id}}/update" method="POST" enctype="multipart/form-data">
        ...
        <div class="row col-md-12">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="title" name="title" value="{{old('title') ? old('title') : $highlight->title}}">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="video" name="video" value="{{$highlight->video}}">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    @if (strlen($highlight->date) > 0)

                    <input type="text" class="form-control" id="date" name="date" value="{{$highlight->date}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="photo" name="photo" value="{{$highlight->photo}}">
                    @error('photo')
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    height: 125px;" name="detail"> {{old('detail') ? old('detail') : $highlight->detail}}</textarea>
            ...
            <button type="submit" class="btn btn-sila btn-sm">Edit HighLight</button>
