...
<div class="card shadow mb-4">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Delete all Fights older than <strong>1 month</strong>? This will keep only Fights from the last 1 month.
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <form action="{{ route('fights.deleteOld', 1) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
    ...
    <div class="modal fade" id="deleteOldModal3" tabindex="-1" aria-labelledby="deleteOldModal3Label" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Delete all Fights older than <strong>3 months</strong>? This will keep only Fights from the last 3 months.
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <form action="{{ route('fights.deleteOld', 3) }}" method="POST" style="display:inline;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-warning">Yes, Delete</button>
                    </form>
    ...
    <div class="card-body">
        <form id="bulkDeleteForm" action="{{ route('fights.bulkDestroy') }}" method="POST">
            @csrf
            @method('DELETE')
        ...
        <div class="modal fade" id="bulkDeleteModal" tabindex="-1" aria-labelledby="bulkDeleteModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Are you sure you want to delete <strong><span id="selectedCountModal">0</span></strong> selected Fight(s)?
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
