...
<head>
    ...
    <title>2M - Cloud Storage Made Simple</title>
...
<body id="index_appBody" class="font-sans antialiased bg-gray-900 text-white">
    ...
    <div id="index_app" class="min-h-screen flex gap-4 p-1 lg:p-4">
        ...
        <div id="index_sidebar"  style="display: none;"  class="min-w-64 max-w-72 bg-gray-800 text-white p-4 transform transition-transform lg:translate-x-0 -translate-x-full fixed lg:relative top-0 left-0 h-[calc(100vh-0.5rem)] lg:h-auto shadow-lg overflow-y-auto z-10 rounded-lg mt-1 mb-1 lg:mt-0 lg:mb-0">
