...
@section('add-newsfeed-light', 'active')
...
<script type="text/javascript">
 var phnomPenhTime = moment().tz("Asia/Phnom_Penh");
$("#date").datetimepicker({
    ...
    $("#date").datetimepicker({
        ...
        forceParse: 0
    }).datetimepicker('update', phnomPenhTime.toDate()); // Set initial value
</script>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="/newsfeed/store" method="POST" enctype="multipart/form-data">
        ...
        <div class="row col-md-12">
            ...
            <button type="submit" class="btn btn-sila btn-sm">Add newsfeed</button>
