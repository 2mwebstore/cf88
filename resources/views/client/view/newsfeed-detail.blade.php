                ...
                <div>
                    <div class="bennertitle mt-2 mb-2" style="padding: 11px;">
                        <div class="d-flex justify-content-between">
                            <div><i class="fas fa-list-alt"></i>     @lang('home.feeds')</div>
                            <div><a href="/feeds" class="text-white">    @lang('home.back')</a></div>
                        </div>
                    </div>
                        ...
                        <div class="modal fade" id="imageModal{{$row->id}}" tabindex="-1" aria-labelledby="imageModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" style="max-width: 1320px; margin: 0 auto;">
                                ...
                                <div class="modal-body text-center">
                                    <img src="{{ $row->photo }}" onerror="this.onerror=null; this.src='/icon/null-image.gif'" alt="Preview" class="img-fluid rounded w-100">
                                </div>
                                </div>
                            </div>
                        </div>
                   <a href="#">
                        <div class="post-author-info">
                            <img src="{{ $row->photoauth }}" onerror="this.onerror=null; this.src='/icon/null.png'">
                            <div>
                            <div>
                                <span class="author-name text-white">{{ $row->name ?? '' }} </span>
                     ...
                     <img onerror="this.onerror=null; this.src='/icon/null-image.gif';" src="{{$row->photo}}" width="100%" class="brd-5 open-image" data-aos="zoom-in" data-aos-duration="800" data-bs-toggle="modal" data-bs-target="#imageModal{{$row->id}}">
