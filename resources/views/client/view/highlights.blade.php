...
<style>
    ...
    <div class="container mt-75">
        <div class="wrapper">
            <div style="overflow: hidden">
                <div class="bennertitle mt-2 mb-2" style="padding: 11px;">
                    ...
                    @lang('home.list highlights')
                </div>
                <div class="param-show " > 
                <div class="text-white date-title aos-init aos-animate" data-aos="zoom-in" data-aos-duration="800">{{$HighlightsPlay->title ?? ''}}</div>

                    <video id="my_video_1" class="video-js vjs-default-skin vjs-16-9" muted preload="auto" controls width="100%" height="350">
                        <source src="{{$HighlightsPlay->video ?? '/icon/null-image.gif'}}" type="video/mp4">
                    </video>
                    <style>
                        .grid-highligh{
                            white-space: nowrap;
                   ...
                   <div class="color-brand date-size aos-init aos-animate" data-aos="zoom-in" data-aos-duration="800">
                    ...
                    <div class="d-flex justify-content-between">
                       <div>
                           ...
                           $specificDate = new DateTime($HighlightsPlay->date ?? '', $timezone);
                ...
                <div class="param-hide" style="max-width: 100%;padding-left: 10px;padding-right: 10px;">
        ...
        <div class="mt-2 mb-2 param-hide">
            @if ($Highlights->total() > 10) 
                @if ($Highlights->currentPage() === 1) 
                    <button class="btn text-white bg-color-brand" disabled >
                        @lang('home.previous')
                    </button>
                @else 
                    <a href="/highlights?page={{$Highlights->currentPage()-1}}">
                        <button class="btn text-white bg-color-brand">
                            @lang('home.previous')
                        </button>
                    </a>
                @endif
                @if ($Highlights->currentPage() === $Highlights->total()) 
