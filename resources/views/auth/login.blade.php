            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                  <div class="row">
                    ...
                    <div class="col-sm-8">
                    <input id="email" type="text" style="text-align: center;" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Email" required autocomplete="email" autofocus>
                        @error('email')
